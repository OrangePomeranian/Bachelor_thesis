...
delecje_raw = pd.read_csv('/Users/daria/Desktop/test2/lista_raw_del_razem.txt', sep =' ')
delecje_clean = pd.read_csv('/Users/daria/Desktop/test2/lista_clean_del_razem.txt', sep =' ')
delecje_raw = delecje_raw.drop(columns = ['Unnamed: 0']) 
delecje_clean = delecje_clean.drop(columns = ['Unnamed: 0']) 

delecje_raw_1 = []
delecje_clean_1 = []
delecje_raw_1 = delecje_raw_1.append(len(delecje_raw))
delecje_clean_1 = delecje_clean_1.append(len(delecje_clean))
...
f.savefig('Liczba_Delecji_Pindelxdddd.png')
...
f.suptitle('Długość delecji dla Pindla przed i po filtracji')
f.text(0.5, 0.04, 'Chromosom', ha='center')
f.text(0.04, 0.5, 'Długość CNV', va='center', rotation='vertical')
f.savefig('Dlugosc_Delecji_Pindel_2.png')
'''
...
f.text(0.5, 0.04, 'Chromosom', ha='center')
f.text(0.04, 0.5, 'Długość CNV', va='center', rotation='vertical')
f.savefig('Dlugosc_Delecji_Pindel_3.png')
'''
end = time.time()
print(end - start)